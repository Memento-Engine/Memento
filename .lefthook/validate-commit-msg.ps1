...
Write-Host '[FAIL] COMMIT MESSAGE VALIDATION FAILED' -ForegroundColor Red
Write-Host ''
...
Write-Host '  [OK] feat(auth): add JWT token validation'
Write-Host '  [OK] fix(api): resolve race condition in query handler'
Write-Host '  [OK] docs: update README with setup instructions'
Write-Host '  [OK] refactor(core): simplify error handling logic'
Write-Host '  [OK] perf(search): optimize database indexing'
Write-Host '  [OK] style: format code with prettier'
Write-Host '  [OK] test(executor): add unit tests for extraction validator'
Write-Host ''
